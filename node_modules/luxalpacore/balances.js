...
function readBalance(wallet, handleBalance){
	...
	db.query(
		...
		FROM outputs "+join_my_addresses+" CROSS JOIN units USING(unit) LEFT JOIN assets on outputs.asset=assets.unit \n\
...
function readSharedBalance(wallet, handleBalance){
	...
	readSharedAddressesOnWallet(wallet, function(arrSharedAddresses){
		...
		db.query(
			...
			FROM outputs CROSS JOIN units USING(unit) LEFT JOIN assets on outputs.asset=assets.unit \n\
