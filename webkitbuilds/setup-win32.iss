...
[Files]
; Source: "..\luxalpabuilds\luxalpa-test\win32\luxalpa.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\luxalpabuilds\{#MyAppPackageName}\win32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
